...
from config import DESTINATION, STOP_WORDS_DESTINATION, API_ID, API_HASH, SESSION, CHATS, STOP_WORDS
...
async def new_message_handler(event):
    ...
    Фильтрует сообщения по схожести и стоп-словам.
    Пересылает сообщения в целевой чат, если они соответствуют условиям.
    """
    try:
